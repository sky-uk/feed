...
// Source: k8s.io/client-go/kubernetes/typed/extensions/v1beta1 (interfaces: IngressInterface,IngressesGetter)
...
import (
	...
	v1beta10 "k8s.io/client-go/applyconfigurations/extensions/v1beta1"
	v1beta11 "k8s.io/client-go/kubernetes/typed/extensions/v1beta1"
)
...
func (m *MockIngressInterface) Apply(arg0 context.Context, arg1 *v1beta10.IngressApplyConfiguration, arg2 v1.ApplyOptions) (*v1beta1.Ingress, error) {
	m.ctrl.T.Helper()
...
func (m *MockIngressInterface) ApplyStatus(arg0 context.Context, arg1 *v1beta10.IngressApplyConfiguration, arg2 v1.ApplyOptions) (*v1beta1.Ingress, error) {
	m.ctrl.T.Helper()
...
func (m *MockIngressInterface) Create(arg0 context.Context, arg1 *v1beta1.Ingress, arg2 v1.CreateOptions) (*v1beta1.Ingress, error) {
	m.ctrl.T.Helper()
...
func (m *MockIngressInterface) Delete(arg0 context.Context, arg1 string, arg2 v1.DeleteOptions) error {
	m.ctrl.T.Helper()
...
func (m *MockIngressInterface) DeleteCollection(arg0 context.Context, arg1 v1.DeleteOptions, arg2 v1.ListOptions) error {
	m.ctrl.T.Helper()
...
func (m *MockIngressInterface) Get(arg0 context.Context, arg1 string, arg2 v1.GetOptions) (*v1beta1.Ingress, error) {
	m.ctrl.T.Helper()
...
func (m *MockIngressInterface) List(arg0 context.Context, arg1 v1.ListOptions) (*v1beta1.IngressList, error) {
	m.ctrl.T.Helper()
...
func (m *MockIngressInterface) Patch(arg0 context.Context, arg1 string, arg2 types.PatchType, arg3 []byte, arg4 v1.PatchOptions, arg5 ...string) (*v1beta1.Ingress, error) {
	m.ctrl.T.Helper()
...
func (m *MockIngressInterface) Update(arg0 context.Context, arg1 *v1beta1.Ingress, arg2 v1.UpdateOptions) (*v1beta1.Ingress, error) {
	m.ctrl.T.Helper()
...
func (m *MockIngressInterface) UpdateStatus(arg0 context.Context, arg1 *v1beta1.Ingress, arg2 v1.UpdateOptions) (*v1beta1.Ingress, error) {
	m.ctrl.T.Helper()
...
func (m *MockIngressInterface) Watch(arg0 context.Context, arg1 v1.ListOptions) (watch.Interface, error) {
	m.ctrl.T.Helper()
...
func (m *MockIngressesGetter) Ingresses(arg0 string) v1beta11.IngressInterface {
	m.ctrl.T.Helper()
