...
func (s *resourceStore) createNamespaceSource() (watchedResource, error) {
...
func (s *resourceStore) createIngressSource() (watchedResource, error) {
...
func (s *resourceStore) createServiceSource() (watchedResource, error) {
